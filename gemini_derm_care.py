...
from PROMPT import INSTRUCTION_DERMA_PROMPT,ATYPICAL_NEVUS_AGENT_PROMPT,MELANOMA_AGENT_PROMPT,DERM_JUDGE_IMAGE_TEXT_AGENT_PROMPT
import pandas as pd
import ast
import argparse
import os
    ...
    for iter_idx, row in tqdm(info.iterrows(), total=len(info), desc="Processing samples"):
        ...
        for attempt in range(MAX_RETRY):
            try:
                ...
                judge_content_list = [
                    DERM_JUDGE_IMAGE_TEXT_AGENT_PROMPT   
                ]
