...
from PROMPT import INSTRUCTION_PROMPT, JUDGE_TEXT_AGENT_PROMPT,EDEMA_AGENT_PROMPT_v2,PNEUMONIA_AGENT_PROMPT_v2,JUDGE_IMAGE_TEXT_AGENT_PROMPT
import pandas as pd
import ast
import argparse
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default='./cxr_gemini_3_flash_blind_care.csv')
